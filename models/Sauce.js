...
const saucesSchema = mongoose.Schema({
    ...
    usersLiked: [{ type: String, required: false, default: []  }], // tableau d'identifiants d'utilisateurs ayant aimé la sauce
    usersDisliked: [{ type: String, required: false, default: [] }], // tableau d'identifiants d'utilisateurs n'ayant pas aimé la sauce
});
